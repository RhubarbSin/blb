...
(deftheme blb-zenburn
  "Based on the Zenburn theme.")

(custom-theme-set-faces
 'blb-zenburn
 '(default ((t (:background "#303030" :foreground "#dcdccc"))))
 '(cursor ((t (:background "#b2b2b2" :foreground "#ffffff"))))
 '(region ((t (:background "#5f5f5f"))))
 '(mode-line ((t (:background "#202522" :foreground "#acbc90"))))
 '(mode-line-inactive ((t (:background "#272c29" :foreground "#88b090"))))
